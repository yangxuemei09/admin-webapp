<template>
  <div class="app-container">
    <div class="head-container">
      <el-input :placeholder="$t('adminRole.name')" v-model="listQuery.name" style="width: 200px;" class="filter-item" @keyup.enter.native="handleFilter"/>
    ...
    <el-table
      ...
      style="width: 100%;">
      <el-table-column :label="$t('adminRole.name')" width="200px" align="center" prop="name" />
...
<script>
import { getAdminRoleList, deleteAdminRole } from '@/api/admin/role'
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      getAdminRoleList(this.listQuery).then(response => {
